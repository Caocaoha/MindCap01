  ...
  return (
    <div className="h-screen w-full bg-black text-white overflow-hidden flex flex-col font-sans select-none">
      <header className="h-16 flex items-center justify-center px-6 relative z-[60]">
        <button onClick={() => { triggerHaptic('medium'); setActiveTab('identity'); }} className={`transition-all duration-500 ${activeTab === 'identity' ? 'text-yellow-500 scale-110' : 'opacity-20'}`}>
      ...
      <main className="flex-1 relative px-4 overflow-hidden">
        ...
        {activeTab === 'mind' && (
          <div className="h-full flex flex-col relative">
            {/* FocusSession: z-50, cao hơn InputBar */}
            ...
            {/* InputBar: pointer-events-none cho container cha */}
            {/* Thêm pb-safe để tránh bị che bởi thanh Home của iPhone, nhưng quan trọng là h-auto */}
