 ...
 * Version: 3.3 - Added Stage Metadata
 */
...
/**
* [NEW]: Metadata cho từng chặng để hiển thị tiêu đề và phong cách UI tương ứng
* Giúp Dashboard và Audit Overlay biết đang ở vùng không gian nào.
*/
export const IDENTITY_STAGES = {
1: { name: "SOI CHIẾU BÓNG TỐI", alias: "AXIT", color: "text-orange-400" },
2: { name: "VIỄN CẢNH KHỐC LIỆT", alias: "AXIT ĐẬM ĐẶC", color: "text-red-500" },
3: { name: "KHOẢNG LẶNG", alias: "SỰ TRUNG THÀNH", color: "text-zinc-400" },
4: { name: "KIẾN TẠO TẦM NHÌN", alias: "ÁNH SÁNG", color: "text-blue-400" },
5: { name: "LẬP LỆNH THỰC THI", alias: "TẠO ĐÀ", color: "text-yellow-500" },
};
