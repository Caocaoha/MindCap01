...
import { AttentionMonitor } from '../../spark/components/attention-monitor'; // [NEW]: Tích hợp cảm biến chú ý

/**
 * [MOD_JOURNEY]: Thành phần hiển thị danh sách nhật ký sống động (v9.3).
 * Giai đoạn 6.31: 
...
export const LivingMemory: React.FC = () => {
  ...
  return (
    <AttentionMonitor> {/* [NEW]: Bọc toàn bộ vùng danh sách Nhật ký */}
        ...
        {entries?.map((item: any) => {
          ...
          return (
            <div 
              ...
              // [NEW]: Gắn nhãn cảm biến để đếm 3 giây hiện diện
              data-attention-target="true"
              data-entry-id={item.id}
              data-entry-type={isTask ? 'task' : 'thought'}
              style={{ 
